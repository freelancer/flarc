...
final class ArcanistDuplicateFunctionDeclarationXHPASTLinterRule
  ...
  public function process(XHPASTNode $root) {
    ...
    foreach ($functions as $function) {
      // If third child is `n_EMPTY` then it is an anonymous function and
   ...
   * @{class:ArcanistDuplicateClassDeclarationXHPASTLinterRule} and should be
   * moved to a parent class.
   */
